...
var require_playground = __commonJS({
  "playground.ts"() {
    ...
    init_dist2();
    init_dist6();
    var editorViews = /* @__PURE__ */ new WeakMap();
    var gardenLanguage = StreamLanguage.define({
      token(stream) {
        if (stream.match("//")) {
          stream.skipToEnd();
          return "comment";
    ...
    var gardenHighlighting = syntaxHighlighting(
    ...
    function setupPlayground() {
      ...
      if (playgroundRunButton && playgroundOutput && playgroundOutput instanceof HTMLElement && playgroundEditor && playgroundEditor instanceof HTMLTextAreaElement) {
